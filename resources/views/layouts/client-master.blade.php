...
<head>
    ...
    <!-- //Custom Theme files -->
    <link href="{{ asset('assets/govihar/css/bootstrap.css') }}" type="text/css" rel="stylesheet" media="all">
    <link href="{{ asset('assets/govihar/css/style.css') }}" type="text/css" rel="stylesheet" media="all">
    <link rel="stylesheet" href="{{ asset('assets/govihar/css/flexslider.css') }}" type="text/css" media="screen" />
    <link type="text/css" rel="stylesheet" href="{{ asset('assets/govihar/css/JFFormStyle-1.css') }}" />
    <!-- js -->
    <script src="{{ asset('assets/govihar/js/jquery.min.js') }}"></script>
    <script src="{{ asset('assets/govihar/js/modernizr.custom.js') }}"></script>
<!-- //js -->
<!-- fonts -->
...
<!--pop-up-->
<script src="{{ asset('assets/govihar/js/menu_jquery.js') }}"></script>
<!--//pop-up-->	
</head>
<body>
	<!--header-->
	<div class="header">
		<div class="container">
			...
			<div class="nav-top">
				<div class="top-nav">
					<span class="menu"><img src="{{ asset('assets/govihar/images/menu.png') }}" alt="" /></span>
					<ul class="nav1">
						...
						<ul class="slides">
							<li>
								<div class="slider-info">
									<img src="{{ asset('assets/govihar/images/1.jpg') }}" alt="">
								</div>
							</li>
							<li>
								<div class="slider-info">
									<img src="{{ asset('assets/govihar/images/2.jpg') }}" alt="">
								</div>
							</li>
							<li>	
								<div class="slider-info">
									<img src="{{ asset('assets/govihar/images/3.jpg') }}" alt="">
								</div>
							</li>
							<li>	
								<div class="slider-info">
									<img src="{{ asset('assets/govihar/images/4.jpg') }}" alt="">
								</div>
							</li>
							<li>	
								<div class="slider-info">
						 ...
						 <div class="resp-tabs-container">
							...
							<div class="tab-2 resp-tab-content" aria-labelledby="tab_item-1">
								<div class="facts">
										<div class="booking-form">
											<!---strat-date-piker---->
											<link rel="stylesheet" href="{{ asset('assets/govihar/css/jquery-ui.css') }}" />
											<script src="{{ asset('assets/govihar/js/jquery-ui.js') }}"></script>
													  <script>
															  $(function() {
																$( "#datepicker,#datepicker1" ).datepicker();
															  });
	...
	<div class="move-text">
		...
		<script type="text/javascript" src="{{ asset('assets/govihar/js/jquery.marquee.min.js') }}"></script>
        <script>
			...
			<div class="slider">
				<div class="arrival-grids">			 
					 <ul id="flexiselDemo1">
						...
						<script type="text/javascript" src="{{ asset('assets/govihar/js/jquery.flexisel.js') }}"></script>			 
				</div>
			</div>
			<!-- //slider -->
		</div>
	...
	<script defer src="{{ asset('assets/govihar/js/jquery.flexslider.js') }}"></script>
	<script src="{{ asset('assets/govihar/js/jquery.easyResponsiveTabs.js') }}" type="text/javascript"></script>
	<script src="{{ asset('assets/govihar/js/js/jquery-ui.js') }}"></script>
	<script type="text/javascript" src="{{ asset('assets/govihar/js/js/script.js') }}"></script>
	<script type="text/javascript">
		$(function(){
